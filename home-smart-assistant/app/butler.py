...
SYSTEM_PROMPT = (
    ...
    "HIEU NGOI NHA: khi duoc hoi ve nha, thiet bi, thanh vien hay thoi quen, hay dung 'Thong tin nha' "
    "da biet va goi search_knowledge / get_home_state / get_environment de tra loi dung va cu the, "
    "khong doan mo ho.\n"
